...
/**
 * This is the model class for table "salutations".
 *
 * The followings are the available columns in table 'salutations':
...
class Salutations extends Webapp1ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('salutationName, description', 'required'),
	...
	public function search()
	{
		...
		$criteria->compare('salutationName',$this->salutationName,true);
