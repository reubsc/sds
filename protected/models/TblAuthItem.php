...
class TblAuthItem extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, type, description, bizrule, data, dateCreated, dateModified, insertedBy, updatedBy', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblAuthAssignments' => array(self::HAS_MANY, 'TblAuthAssignment', 'itemname'),
			'tblAuthItemChildren' => array(self::HAS_MANY, 'TblAuthItemChild', 'child'),
			'tblAuthItemChildren1' => array(self::HAS_MANY, 'TblAuthItemChild', 'parent'),
		);
	}
