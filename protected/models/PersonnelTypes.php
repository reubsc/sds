...
/**
 * This is the model class for table "personnelTypes".
 *
 * The followings are the available columns in table 'personnelTypes':
 * @property string $personnelTypeID
 * @property string $personnelTypeName
...
class PersonnelTypes extends Webapp1ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('personnelTypeName, description', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'personnelTypeName' => 'Personnel Type Name',
	...
	public function search()
	{
		...
		$criteria->compare('personnelTypeName',$this->personnelTypeName,true);
	 ...
	 * @return PersonnelTypes the static model class
	 */
